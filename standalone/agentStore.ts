...
export function buildPMSystemPrompt(agent: PersistentAgent): string {
	...
	const lines = [
		...
		'technical briefing and produce 5 genuinely DIFFERENT UX design briefings — each exploring',
		'a distinct creative direction. Not minor variations, but truly different conceptual approaches.',
		'',
		`Your persistent memory file is at: ${memoryPath}`,
		'Read this file at the start of each session to recall context from previous sessions.',
		'Update it as you work with important decisions, progress, patterns, and context you want to remember across sessions.',
