...
export const TOOL_ACTIVITY_CATEGORY: Record<string, string> = {
  ...
  'mcp__mempalace__mempalace_status': 'memory',
  'mcp__mempalace__mempalace_list_wings': 'memory',
  'mcp__mempalace__mempalace_list_rooms': 'memory',
  'mcp__mempalace__mempalace_get_taxonomy': 'memory',
  'mcp__mempalace__mempalace_search': 'memory',
  'mcp__mempalace__mempalace_check_duplicate': 'memory',
  'mcp__mempalace__mempalace_get_aaak_spec': 'memory',
  'mcp__mempalace__mempalace_add_drawer': 'memory',
  'mcp__mempalace__mempalace_delete_drawer': 'memory',
  'mcp__mempalace__mempalace_kg_query': 'memory',
  'mcp__mempalace__mempalace_kg_add': 'memory',
  'mcp__mempalace__mempalace_kg_invalidate': 'memory',
  'mcp__mempalace__mempalace_kg_timeline': 'memory',
  'mcp__mempalace__mempalace_kg_stats': 'memory',
  'mcp__mempalace__mempalace_traverse': 'memory',
  'mcp__mempalace__mempalace_find_tunnels': 'memory',
  'mcp__mempalace__mempalace_graph_stats': 'memory',
  'mcp__mempalace__mempalace_diary_write': 'memory',
  'mcp__mempalace__mempalace_diary_read': 'memory',
}
